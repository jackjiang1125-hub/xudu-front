...
.cell{ padding:10px; border-radius:10px; background: rgba(20,26,40,.7); border:1px solid rgba(255,255,255,.08); text-align:center; }
.cell .name{ font-size:12px; opacity:.85; }
...
.cell.close{ box-shadow: 0 0 10px rgba(255,255,255,.08) inset; }
